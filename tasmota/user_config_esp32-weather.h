// tasmota32-sievju-weather
// Configuration for specific firmware for esp32-wroom-32u module used as weather station.
...
#define CODE_IMAGE_STR "esp32-weather"
...
//   13: unused
//   14: 161 =Input2
//   15: 224 =Relay1, MOSFET switch for heater
//   16: 5376 =WindMeter speed counter pin
//   17: 352 =Counter1 (windspeed)
//   18: unused
//   19: unused
//   20: non-existent
//   21: 640 =I2C_SDA
...
//   34: 164 =Input5
//   35: 165 =Input6
//   36: 4704 =ADC Input1 (Temperature)
//   39: 4705 =ADC Input2 (Rel. Humidity)
#define USER_TEMPLATE "{\"NAME\":\"ESP32-WEATHER\",\"GPIO\":[32,1,8256,1,576,0,0,0,160,1,161,224,5376,352,1,1,0,640,608,1,0,1,162,163,0,0,0,0,1,1,164,165,4704,0,0,4705],\"FLAG\":0,\"BASE\":1}"
#undef MODULE
...
#undef FRIENDLY_NAME
#define FRIENDLY_NAME          "Sievju ESP32-Weather"    // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa

#undef OTA_URL
#define OTA_URL                "http://sievju.org/tasmota_firmware/tasmota32-sievju-weather.bin"  // [OtaUrl]

#undef MQTT_TOPIC
#define MQTT_TOPIC             PROJECT "-esp32-weather"  // [Topic]
...
#ifndef USE_MT6701                               // Enable support for MT6701 rotary angle Hall sensor
#define USE_MT6701
#endif
...
#define USE_WINDMETER                            // Enable support for analog anemometer (+2k2 code)
#endif
