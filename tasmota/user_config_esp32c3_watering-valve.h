// tasmota32_watering-valve
// Configuration for specific firmware for esp32-wroom-32u module used for watering valve control.
...
#define CODE_IMAGE_STR "esp32-watering-valve"
...
#define USER_TEMPLATE "{\"NAME\":\"ESP32-WATERING-VALVE\",\"GPIO\":[32,1,576,1,8256,0,0,0,0,261,256,1,0,0,1,1,0,640,608,1,0,1,258,257,0,0,0,0,260,259,1,1,1,0,0,1],\"FLAG\":0,\"BASE\":1}"
#undef MODULE
...
#undef FRIENDLY_NAME
#define FRIENDLY_NAME          "Watering-Valve"    // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa

#undef OTA_URL
#define OTA_URL                "http://sievju.org/tasmota_firmware/tasmota32-watering-valve.bin"  // [OtaUrl]

#undef MQTT_TOPIC
#define MQTT_TOPIC             PROJECT "watering-valve"  // [Topic]
