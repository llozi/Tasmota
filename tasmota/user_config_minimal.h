/*********************************************************************************************\
 * [tasmota-sievju-minimal]
 * Provide the smallest image possible while still enabling a webserver for intermediate image load
\*********************************************************************************************/

#undef CODE_IMAGE_STR
#define CODE_IMAGE_STR "sievju-minimal"

#undef FALLBACK_MODULE
#define FALLBACK_MODULE        SONOFF_BASIC        // [Module18] Select default module on fast reboot where USER_MODULE is user template

#undef OTA_URL
#define OTA_URL                "http://sievju.org/tasmota_firmware/tasmota-sievju-minimal.bin"  // [OtaUrl]
